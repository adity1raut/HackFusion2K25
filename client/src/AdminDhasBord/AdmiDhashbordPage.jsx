          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">
                Elections for the various student activities position to carry out different tasks.
              </span>
            </div>
          </div>
          <button
            onClick={() => navigate('/admin/dashboard/election')}
            className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-300"
          >
            View Details
          </button>
        </div>
