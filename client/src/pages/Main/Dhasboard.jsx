      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-20 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Elections</h2>
          </div>
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">Total Candidates:</span>
              <span className="ml-2 font-medium text-gray-800">{electionData?.length || 0}</span>
            </div>
          </div>
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">Candidates Elected:</span>
            </div>
          </div>
          <button
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium text-gray-800">{bookingData?.booked?.length || 0}</span>
            </div>
            <div className="flex items-center">
              <span className="text-gray-600">Available Facilities:</span>
              <span className="ml-2 font-medium text-gray-800">{bookingData?.available?.length || 0}</span>
            </div>
          </div>
          <button
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium text-gray-800">{leaveData?.pending || 0}</span>
            </div>
            <div className="flex items-center">
              <span className="text-gray-600">Approved:</span>
              <span className="ml-2 font-medium text-gray-800">{leaveData?.approved || 0}</span>
            </div>
          </div>
          <button
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium text-gray-800">{complaintData?.processed || 0}</span>
            </div>
            <div className="flex items-center">
              <span className="text-gray-600">Pending:</span>
              <span className="ml-2 font-medium text-gray-800">{complaintData?.pending || 0}</span>
            </div>
          </div>
          <button
            onClick={() => navigate('/dashboard/complaint-details')}
            className="w-full py-2 px-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-md transition-all duration-300"
          >
            View Details
          </button>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Faculty Availability</h2>
          </div>
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">Available:</span>
              <span className="ml-2 font-medium text-gray-800">{facultyAvailability.available}</span>
            </div>
            <div className="flex items-center">
              <span className="text-gray-600">Unavailable:</span>
              <span className="ml-2 font-medium text-gray-800">{facultyAvailability.unavailable}</span>
            </div>
          </div>
          <button
        ...
        {/* Cheating Resolution Card */}
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          <div className="flex items-center gap-3 mb-4">
            <Users className="w-6 h-6 text-indigo-600" />
            <h2 className="text-xl font-semibold text-gray-800">Cheating Resolution</h2>
          </div>
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">Available:</span>
